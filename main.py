...
conn = sqlite3.connect('amazon_products.db')  # <-- Change this
cursor = conn.cursor()

# Step 2: Fetch all product records
...
es = Elasticsearch("http://localhost:9200",
                   basic_auth=("elastic", "elastic"))  # <-- Or your ES Cloud URL

# Step 4: Create index with mapping (optional but recommended)
...
# Step 5: Prepare generator for bulk insert
def generate_docs():
    for row in rows:
        doc = dict(zip(columns, row))  # Row as dict
        yield {
            "_index": "products",
            "_id": doc["id"],         # Use SQLite id as ES _id
            "_source": doc
        }
...
print("✅ Successfully inserted products into Elasticsearch.")
...
# genre_list = ["Men","Boys","Babies","Girls", "Jackets","Gaming","Decor"]
...
#     "Jackets":"https://www.amazon.com/s?k=Spring+Jackets&i=fashion&rh=n%3A7141123011%2Cp_n_feature_fourteen_browse-bin%3A24196132011&dc&_encoding=UTF8&content-id=amzn1.sym.bad2a3cf-6397-46b0-aa92-6036dbc4afb6&crid=28AAZ2JDZCYX1&pd_rd_r=71df4314-3b47-46e5-a6da-ffad40939826&pd_rd_w=0bp0o&pd_rd_wg=cU8fB&qid=1751512483&rnid=24196130011&sprefix=spring+jackets%2Caps%2C140&xpid=_pZM-PTOjAK6f&ref=sr_pg_{page}",
#     "Gaming":"https://www.amazon.com/s?k=video+gaming&_encoding=UTF8&content-id=amzn1.sym.f0670b1b-e1fd-4c67-a2b1-b8a347243628&pd_rd_r=cadc6182-519d-4756-b80b-5e30f580939b&pd_rd_w=qJYRA&pd_rd_wg=HFM5T&qid=1751512742&xpid=ylNp403LFQ2_H&ref=sr_pg_{page}",
#     "Decor":"https://www.amazon.com/s?k=home+storage&_encoding=UTF8&content-id=amzn1.sym.83009b1f-702c-4be7-814b-0240b8f687d2&pd_rd_r=71df4314-3b47-46e5-a6da-ffad40939826&pd_rd_w=oGjpr&pd_rd_wg=cU8fB&qid=1751513126&xpid=K8_5pUHtbK9if&ref=sr_pg_{page}"
# }
...
#     "Jackets":"https://www.amazon.com/s?k=Spring+Jackets&i=fashion&rh=n%3A7141123011%2Cp_n_feature_fourteen_browse-bin%3A24196132011&dc&page={pg_no}&_encoding=UTF8&content-id=amzn1.sym.bad2a3cf-6397-46b0-aa92-6036dbc4afb6&crid=28AAZ2JDZCYX1&pd_rd_r=71df4314-3b47-46e5-a6da-ffad40939826&pd_rd_w=0bp0o&pd_rd_wg=cU8fB&qid=1751512489&rnid=24196130011&sprefix=spring+jackets%2Caps%2C140&xpid=_pZM-PTOjAK6f&ref=sr_pg_{pg_no}",
#     "Gaming":"https://www.amazon.com/s?k=video+gaming&page={pg_no}&_encoding=UTF8&content-id=amzn1.sym.f0670b1b-e1fd-4c67-a2b1-b8a347243628&pd_rd_r=cadc6182-519d-4756-b80b-5e30f580939b&pd_rd_w=qJYRA&pd_rd_wg=HFM5T&qid=1751512751&xpid=ylNp403LFQ2_H&ref=sr_pg_{pg_no}",
#     "Decor":"https://www.amazon.com/s?k=home+storage&page={pg_no}&_encoding=UTF8&content-id=amzn1.sym.83009b1f-702c-4be7-814b-0240b8f687d2&pd_rd_r=71df4314-3b47-46e5-a6da-ffad40939826&pd_rd_w=oGjpr&pd_rd_wg=cU8fB&qid=1751513155&xpid=K8_5pUHtbK9if&ref=sr_pg_{pg_no}"
# }
